...
///
///     rc-funnel-attributes headaches --user <the id this run used>
final class PaywallFunnelUITests: XCTestCase {
    ...
    func testTestStorePurchaseRecordsTheConversion() {
        ...
        let app = XCUIApplication(bundleIdentifier: "com.jackwallner.headachelogger")
