...
/// On-device record of how someone met Headache Pro before they bought it:
/// which surfaces they saw, how many times, how early they were asked, and how
/// long it took.
///
...
enum ConversionDiagnostics {
    private static let logger = Logger(subsystem: "com.jackwallner.headachelogger", category: "Conversion")

    /// Spelled out rather than taken from the data layer, so this file can join
    /// the unit-test bundle without dragging SwiftData in behind it.
    static let suiteName = "group.com.jackwallner.headachelogger"
    ...
    private static let impressionPrefix = "headache_"
